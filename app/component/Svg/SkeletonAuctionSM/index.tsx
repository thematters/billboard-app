...
const SkeletonAuctionSM = ({ css, width = 311, height = 412 }: SVGProps) => (
  <svg
    ...
    fill="none"
  >
    <path fill="#333" d="M0 0h64v24H0V0ZM88 0h64v24H88V0ZM0 48h220v24H0V48Z" />
    <g clipPath="url(#a)">
      <path fill="#333" d="M0 88h311v52H0z" />
      ...
      <mask id="g" fill="#fff">
        <path d="M0 400h311v54H0v-54Z" />
      </mask>
      <path fill="#212121" d="M0 400h311v54H0v-54Z" />
      <path
        fill="#80AB01"
        fillOpacity={0.4}
        d="M311 453H0v2h311v-2Z"
        mask="url(#g)"
      />
    </g>
    <defs>
      <clipPath id="a">
        <path fill="#fff" d="M0 88h311v324H0z" />
      </clipPath>
    </defs>
  </svg>
)

export default memo(SkeletonAuctionSM)
